    ...
    defineField({
      ...
      options: {
        list: [
          ...
          { title: 'Logos & Brand Marks', value: 'LOGOS' },
          { title: 'Brand Identity', value: 'BRAND_IDENTITY' },
          { title: 'Packaging & Structure', value: 'PACKAGING' },
          { title: 'Posters & Print', value: 'POSTERS' },
          { title: 'Screenprint & Halftone', value: 'SCREENPRINT' },
          { title: 'Visual Studies & Lab', value: 'STUDIES' },
          { title: '3D & Motion', value: 'MOTION' },
          { title: 'Typography & Editorial', value: 'TYPOGRAPHY' },
        ],
      },
      validation: (rule) => rule.required(),
    }),
